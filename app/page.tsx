...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-sky-50 to-blue-50 py-8 md:py-12 border-b">
        <div className="container grid md:grid-cols-2 gap-6 md:gap-8 items-center">
          <div className="space-y-4 md:space-y-5">
            ...
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight">
              Discover the Latest in Apple Innovations
            </h1>
            <p className="text-gray-400 mb-4 md:mb-6 max-w-md">
              Your trusted source for the latest Apple news, in-depth reviews,
              helpful guides, and exclusive deals on Apple products.
            </p>
          ...
          <div className="relative h-[200px] md:h-[250px] lg:h-[350px] rounded-xl overflow-hidden shadow-lg">
            <Image
          ...
          <div className="lg:col-span-2 space-y-12 md:space-y-16">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <Link href={`/news/<span class="math-inline">\{newsPosts\[0\]\.subcategory\}/</span>{newsPosts[0].slug}`}>
                  <Card className="overflow-hidden border-0 shadow-lg">
                    <div className="relative h-[200px] md:h-[220px]">
                      ...
                      <div className="absolute bottom-0 left-0 p-4 text-white">
                        <div className="text-xs font-medium mb-2 text-sky-300">
                ...
                <div className="space-y-3 md:space-y-4">
                  {newsPosts.slice(1, 4).map((article, index) => (
                    <Link
                      key={index}
                      href={`/news/<span class="math-inline">\{article\.subcategory\}/</span>{article.slug}`}
                    ...
                    >
                      ...
                      <div>
                        <div className="text-xs text-sky-500 font-medium mb-1">
                          {article.category}
                        </div>
            ...
            <AdBanner size="300x250" className="mx-auto" id="home-mid-rectangle" />
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                {reviewPosts.slice(0, 3).map((review, index) => (
                  ...
                  >
                    <Link href={`/reviews/<span class="math-inline">\{review\.subcategory\}/</span>{review.slug}`}>
            ...
            <section>
              <div className="flex items-center justify-between mb-4 md:mb-6">
                <h2 className="text-xl md:text-2xl font-bold">Helpful Guides</h2>
                <Link
                  href="/guides"
                  className="text-sky-500 hover:text-sky-600 flex items-center text-sm font-medium"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  ...
                  <Card
                    ...
                    className="overflow-hidden border-0 shadow-md hover:shadow-lg transition-shadow"
                  >
                    <Link href={`/guides/<span class="math-inline">\{guide\.subcategory\}/</span>{guide.slug}`} className="flex h-full">
            ...
            <section className="bg-gradient-to-r from-sky-50 to-blue-50 p-6 md:p-8 rounded-xl">
              <div className="max-w-xl">
                <h2 className="text-xl md:text-2xl font-bold mb-3">
                  Stay Updated with Apple News
                </h2>
                <p className="text-muted-foreground mb-4 md:mb-5">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-50 p-6 rounded-xl">
              ...
              <div className="space-y-4">
                {[...newsPosts, ...reviewPosts].slice(0, 5).map(
                  (article, index) => (
                    <Link
                      key={index}
                      href={
                        article.category === "Reviews"
                          ? `/reviews/<span class="math-inline">\{article\.subcategory\}/</span>{article.slug}`
                          : `/news/<span class="math-inline">\{article\.subcategory\}/</span>{article.slug}`
                      }
                  ...
                  >
                    <Link href="/deals" className="flex p-3 items-center">
                      <div className="relative w-12 h-12 flex-shrink-0 rounded-md overflow-hidden mr-3">
                        <Image
                          src={`/placeholder.svg?height=50&width=50&text=Deal${
                            index + 1
                          }`}
                          alt={`Deal ${index + 1}`}
                          fill
